...
def load_data_from_api(*args, **kwargs):
    ...
    set_global_variable('load_player_data', key='authorization_header', value=authorization_header)
    set_global_variable('load_player_data', key='accept_language_header', value='en-US')
    set_global_variable('load_player_data', key='accept_header', value='application/json')
